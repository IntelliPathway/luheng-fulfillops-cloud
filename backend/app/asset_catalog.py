...
def _case_payload(
    ...
    return {
        ...
        "principal_cents": profile.principal_cents if profile else None,
        "interest_cents": profile.interest_cents if profile else None,
        "fee_cents": profile.fee_cents if profile else None,
        "first_overdue_date": profile.first_overdue_date if profile else None,
        "last_contact_at": profile.last_contact_at if profile else None,
