...
|---|---|---|---|---|
| `v0.15.0` | React 19 + Vite 6 | FastAPI + 受控 Agent Gateway | PostgreSQL + 独立 Worker | ECS + 1Panel Compose |
...
3. 在“AI 与渠道”完成配置、连接测试、自测和管理员启用。
4. 创建履约活动，查看案件范围、预算、策略和渠道预检。
5. 在异常、履约计划和回款页验证保护、签约、分期、对账、退款与计佣。
...
| [v0.15 发布说明](RELEASE_v0.15.0.md) | 发布与验收 | 资产与案件批量导入闭环 |
