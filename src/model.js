...
export const titles = {overview:'工作台',activities:'清收活动',assets:'资产包',cases:'案件',plans:'履约计划',payments:'回款与佣金',agents:'Agents',exceptions:'异常中心',logs:'运行记录',strategy:'策略与知识',integrations:'AI 与渠道',usage:'用量与账单',settings:'组织设置'};
